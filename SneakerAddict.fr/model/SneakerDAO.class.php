...
class SneakerDAO {
  ...
  function get(int $id) : Sneaker
  {
   ...
   $sneaker  = new Sneaker($sneakerArray["id"],$sneakerArray["marque"],$sneakerArray["modele"],$sneakerArray["couleur"],$sneakerArray["gamme"],$sneakerArray["prix"], $sneakerArray["image"]);
   return $sneaker;
 }
